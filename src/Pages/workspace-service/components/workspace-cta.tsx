...
const WorkspaceCta = () => {
  return (
    <div className="max-w-[84rem] mx-auto my-16 rounded-2xl bg-gradient-to-t from-[#1D3A8A] to-[#214cc3] border border-white/20 p-10 md:p-16 flex flex-col items-center text-center shadow-lg">
      <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Ready to create your Workspace?</h2>
      <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl">
        Are you an admin with an amazing workspace to offer? Upload your space now and connect with professionals searching for their next productive environment. Share your space and help teams achieve more!
      </p>
      <div className="flex flex-col md:flex-row gap-4 justify-center w-full max-w-xl group">
