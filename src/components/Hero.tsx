...
const Hero = () => {
    return (
        <div className="flex flex-col items-center justify-center h-screen px-4">
            <span className="items-center rounded-full flex border-[1px] bg-[#e6edfa] border-[#1B04BE] p-1 rounded-lg text-[#1B04BE] mb-3 text-sm md:text-base">
                <span className='rounded-full p-1 bg-[#1B04BE] text-white mr-1'>
            ...
            <div className="flex flex-col md:flex-row gap-4 mt-6 w-full md:w-auto justify-center items-center">
                ...
                <button className="w-full md:w-auto border border-[#4f7be7] text-[#4f7be7] hover:bg-[#e6edfa] hover:text-[#1B04BE] rounded-[0.5rem] p-2 px-6 transition">
                    Explore Features
                </button>
            </div>
